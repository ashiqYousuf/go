...
/*
	👏1. SENDING OR RECEIVING ON A CHANNEL IS BLOCKING IN NATURE UNTIL SENDER FINDS A RECEIVER OR RECEIVER FINDS A SENDER
	👏2. MAIN SHOULD BLOCK TO ALLOW OTHER GO-ROUTINES TO EXECUTE (time.Sleep() or Stdin or Reading from Channel) WHICH ARE CREATED IN MAIN
